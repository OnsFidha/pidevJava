...
//        if (commentaireField != null) {
 //           String newText = commentaireField.getText().trim(); // Ignorer les espaces vides autour du texte
//
//            if (!validerCommentaire(newText)) {
//                textError.setText("Le commentaire doit contenir entre 8 et 800 caractères.");
//                return; // Sortir de la méthode si la validation échoue
//            } else {
//                textError.setText(""); // Effacer le message d'erreur s'il est affiché
//            }
