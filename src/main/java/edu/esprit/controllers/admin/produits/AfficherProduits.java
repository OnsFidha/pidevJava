...
public class AfficherProduits extends AdminContentPanel{
                ...
                alert.showAndWait().ifPresent(response -> {
                    if (response == ButtonType.OK) {
                        try {
                            ...
                            FXMLLoader loader = new FXMLLoader(getClass().getResource("/admin/produits/ModifierProduit.fxml"));
    ...
    void goToAddProductView(ActionEvent event) {
        // Load the AnotherView.fxml file
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/admin/produits/AjouterProduit.fxml"));
            Parent root = loader.load();
